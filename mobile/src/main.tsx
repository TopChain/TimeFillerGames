...
const root=document.getElementById('root');if(!root)throw new Error('Mobile app root is missing.');createRoot(root).render(<React.StrictMode><NativeShellV2><HomePage/><AppearanceControl/><CoHostRecoveryAgentV3/><PrivacyControls/></NativeShellV2></React.StrictMode>);
